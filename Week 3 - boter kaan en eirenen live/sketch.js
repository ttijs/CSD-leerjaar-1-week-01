...
function mousePressed() {
    ...
    let geklikt = false; // om te voorkomen dat de  volgende speler aan de beurt kan voordat het klikken goed is afgerond
    if (mouseX > 200 && mouseX < 400 && mouseY > 100 && mouseY < 300 && cell1 == 0 && geklikt == false) {
        //console.log("geklkikoltk olp cel 1");
        cell1 = playerPlaying;
        geklikt = true;
    }
    if (mouseX > 400 && mouseX < 600 && mouseY > 300 && mouseY < 500 && cell5 == 0 && geklikt == false) {
        //    console.log("geklkikoltk olp cel 1")
        cell5 = playerPlaying;
        geklikt = true;
    }
